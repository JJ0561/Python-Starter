...
import { Shield, Activity, Bell, ChevronRight, Terminal, Home, Zap, Cpu, Settings } from 'lucide-react';
...
export default function Hub() {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white font-sans overflow-hidden selection:bg-white/20">
        ...
        <header className="flex items-center justify-between px-6 py-5 md:px-10 md:py-8 border-b border-white/5 bg-black/10 backdrop-blur-md">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg md:text-2xl font-mono tracking-[0.2em] font-bold text-white uppercase leading-none mb-1">
                Orion System
              </h1>
                ...
                >
                  <div className={`relative flex flex-col h-full rounded-[15px] bg-[#0a0a0a]/90 backdrop-blur-xl border transition-colors duration-500 p-6 overflow-hidden ${profile.borderClass}`}>
                    ...
                    <div className="mt-auto pt-5 md:pt-6 border-t border-white/5 relative z-10 flex items-center justify-between group-hover:border-white/10 transition-colors duration-500">
                      ...
                      <button className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:text-white group-hover:border-white/30 bg-white/5 group-hover:bg-white/10 transition-all duration-500 transform group-hover:translate-x-1">
